...
export function ErrorState({
  ...
  return (
    <div className="flex flex-col items-center justify-center rounded-[28px] border border-[var(--border)] bg-white px-6 py-14 text-center shadow-[var(--shadow-card)] sm:py-16">
      <span className="mb-4 flex h-12 w-12 items-center justify-center rounded-2xl bg-[var(--danger-bg)]">
